					...
					<div class="container">
						...
						<div style="margin-top: 50px; margin-left: 300px;">
							<table class="table" style="margin-top: 30px;">
								<tbody>
									<tr>
										<form action="{{url('/bayar/confirm/'.$pesanan['email'])}}" method="POST">
											{{ csrf_field() }}
											<div class="form-group">
												<label class="col-md-4 control-label">Jenis Mobil</label>
												<div class="col-md-8 inputGroupContainer">
													<input type="text" class="form-control" name="email_owner" value="{{$pesanan['jenis_mobil']}}" readonly>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 control-label">Durasi</label>
												<div class="col-md-8 inputGroupContainer">
													<input type="text" class="form-control" name="durasi" value="{{$pesanan['durasi']}} " readonly>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 control-label">Golongan</label>
												<div class="col-md-8 inputGroupContainer">
													<input type="text" class="form-control" name="golongan" value="{{$pesanan['golongan']}}" readonly>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 control-label">Plat</label>
												<div class="col-md-8 inputGroupContainer">
													<input type="text" class="form-control" name="id_mobil" value="{{$pesanan['id_mobil']}}" readonly>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 control-label">Total Bayar</label>
												<div class="col-md-8 inputGroupContainer">
													<input type="text" class="form-control" name="total_bayar" value="{{$pesanan['harga_total']}}"readonly>
												</div>
											</div>
											<div class="form-group">
