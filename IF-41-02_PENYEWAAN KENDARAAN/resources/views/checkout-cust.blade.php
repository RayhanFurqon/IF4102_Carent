...
<body>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#detail-modal_{{$c->id_transaksi}}" >Detail</button>
                                    </td>
                                    <td>
                                        {{$c->status}}
                                    </td>
    ...
    <div id="detail-modal_{{$d->id_transaksi}}" class="modal fade" role="dialog">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$d->tgl_transaksi}}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Jenis Mobil</label>
                            <input type="text" value="{{$d->jenis_mobil}}"class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Plat Nomor</label>
                            <input type="text" value="{{$d->id_mobil}}"class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Nama Garasi</label>
                            <input type="text" value="{{$d->nama_garasi}}"class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Total Bayar</label>
                            <input type="text" value="{{$d->total_bayar}}"class="form-control" readonly>
                        </div>
                    </form>
                </div>
