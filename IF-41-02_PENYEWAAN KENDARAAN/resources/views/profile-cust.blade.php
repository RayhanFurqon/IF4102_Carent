...
<body>
	<div class="d-flex">
        ...
        <div id="page-content-wrapper" style="background-color: #f4f4f5">
                @foreach($data_cust as $data)
            <div class="jumbotron jumbotron-fluid" style="height: 300px;background-color: black;
            background-image: url('{{url('asset/assets/5.jpg')}}'); ">
                <div class="container">
                    <div class="row d-flex justify-content-center">
                        <div class="col-2 ">
                                <img src="{{$data->foto_profile}}" class="img-thumbnail" style="height: 200px;"> 
                        </div>
							...
							<div class="col-sm-12">
                                    <form>
                                        <div class="form-group">
                                            <label>Email : </label>
                                            <input type="email" class="form-control" value="{{$data->email_cust}}"readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Password : </label>
                                            <input type="password" class="form-control" value="{{$data->password}}" readonly>
                                        </div>
                                    @endforeach
                                        <center>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @foreach($data_cust as $a)
                    <center>
                    <div class="col-8">
                        <img src="{{$a->foto_profile}}" class="img-thumbnail rounded" style="margin-bottom: 10px; height: 200px;">
                    </div>
                    </center>
                    <form action="{{url('/customer/changePP')}}"  method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                    ...
                    @endforeach
                    <form action="{{url('/customer/changePass')}} "method="POST">
                        {{csrf_field()}}
                        <div class="form-group" style="margin-left:35px;margin-right:35px">
