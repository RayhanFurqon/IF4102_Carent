...
<body>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#detail_modal{{$c->id_transaksi}}">Detail</button>
										</td>
									</tr>
									@endforeach
								</tbody>
	...
	<div id="detail_modal{{$cek->id_transaksi}}" class="modal fade" role="dialog">
				...
				<div class="modal-body">
					<form>
						<div class="form-group">
							...
							<input type="text" class="form-control" value="{{$cek->tgl_transaksi}}" readonly>
						</div>
						<div class="form-group">
							<label>Jenis Mobil</label>
							<input type="text" class="form-control" value="{{$cek->jenis_mobil}}" readonly>
						</div>
						<div class="form-group">
							<label>Plat Nomor</label>
							<input type="text" class="form-control" value="{{$cek->id_mobil}}" readonly>
						</div>
						<div class="form-group">
							<label>Nama Pemesan</label>
							<input type="text" class="form-control" value="{{$cek->nama}}" readonly>
						</div>
						<div class="form-group">
							<label>Total Bayar</label>
							<input type="text" class="form-control" value="{{$cek->total_bayar}}" readonly>
						</div>
						<div class="form-group">
							<label>Metode</label>
							<input type="text" class="form-control"value="{{$cek->metode}}" readonly>
						</div>
					</form>
				</div>
