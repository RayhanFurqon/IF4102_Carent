...
<body>
					...
					<div class="row">
						...
						<div class="container-fluid">
							<table class="table">
								...
								<tbody>
									<?php $__currentLoopData = $data_mobil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										<td>
                                            <?php echo e($d->golongan); ?>  
                                        </td>
                                        <td>
                                            <?php echo e($d->id_mobil); ?>

                                        </td>
                                        <td>
                                            <?php echo e($d->jenis_mobil); ?>

                                        </td>
										<td>
											<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#statusmodal_<?php echo e($d->id_mobil); ?>">Ubah Status</button>
										</td>
									</tr>
	...
	<!-- modal -->
	<?php $__currentLoopData = $data_mobil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<div id="statusmodal_<?php echo e($m->id_mobil); ?>" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action='<?php echo e(url('/owner/changeStatus/'.$m->id_mobil)); ?>' method='POST'>
					<?php echo e(csrf_field()); ?>

					<div class="form-group">
						<label for="sel1">Status saat ini : <span class="badge badge-info"><?php echo e($m->status); ?></span> </label>
...
<?php /**PATH C:\xampp\htdocs\website_carent\resources\views/garasi.blade.php ENDPATH**/ ?>