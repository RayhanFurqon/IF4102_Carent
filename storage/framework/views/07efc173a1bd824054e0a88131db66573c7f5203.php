...
<body>
	<div class="d-flex">
		...
		<div id="page-content-wrapper" style="background-color: #f4f4f5">
			<div class="container-fluid">
				...
				<h1 style="text-align: center; margin-bottom: 45px">Checkout Pembayaran</h1>
				<!-- produk produk -->
				<div class="row">
					<!-- card 1 -->
					<div class="container-fluid">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#detail-modal_<?php echo e($c->id_transaksi); ?>" >Detail</button>
                                    </td>
                                    <td>
                                        <?php echo e($c->status); ?>
    ...
    <?php $__currentLoopData = $checkout; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div id="detail-modal_<?php echo e($d->id_transaksi); ?>" class="modal fade" role="dialog">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo e($d->tgl_transaksi); ?>" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Jenis Mobil</label>
                            <input type="text" value="<?php echo e($d->jenis_mobil); ?>"class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Plat Nomor</label>
                            <input type="text" value="<?php echo e($d->id_mobil); ?>"class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Nama Garasi</label>
                            <input type="text" value="<?php echo e($d->nama_garasi); ?>"class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Total Bayar</label>
                            <input type="text" value="<?php echo e($d->total_bayar); ?>"class="form-control" readonly>
                        </div>
                    </form>
                </div>
...
<?php /**PATH C:\xampp\htdocs\website_carent\resources\views/checkout-cust.blade.php ENDPATH**/ ?>