...
<head>
    ...
    <link href="<?php echo e(url('asset/css/regist.css')); ?>" rel="stylesheet">
...
<body>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex justify-content-center" style="margin-top: 10px">
                                <a class="btn btn-primary btn-lg"  href="<?php echo e(url('/registrasi/owner')); ?>">Owner</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="d-flex justify-content-center">
                            ...
                            <div class="d-flex justify-content-center" style="margin-top: 10px">
                                <a class="btn btn-primary btn-lg"  href="<?php echo e(url('/registrasi/customer')); ?>">Customer</a>   
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php /**PATH C:\xampp\htdocs\website_carent\resources\views/registrasi.blade.php ENDPATH**/ ?>