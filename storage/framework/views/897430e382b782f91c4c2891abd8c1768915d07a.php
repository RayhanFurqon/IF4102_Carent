    ...
    <body>
        <div class="container-fluid" style="margin-top: 100px" >
            ...
            <div class="row d-flex justify-content-center" id="form-registrasi">
                ...
                <div class="col-6" >
                    <form action="<?php echo e(url('/registrasi/owner/submit')); ?>" method="POST" enctype="multipart/form-data">
...
</html><?php /**PATH C:\xampp\htdocs\website_carent\resources\views/registrasi_owner.blade.php ENDPATH**/ ?>