...
<body style="background-image: url('<?php echo e(url('/asset/assets/6.jpg')); ?>');background-size: cover;">
    <div class="container">
        <div class="d-flex justify-content-end">
            <img src="<?php echo e(url('/asset/assets/7.png')); ?>" style="height: 100px;">
        </div>
        <div class="row d-flex justify-content-center" style="margin-top: 100px">
            <div class="col-lg-4 col-md-4">
                <form  method="POST" class="bg-warning" action="<?php echo e(url('/login/auth')); ?>" style="background-color: white; padding: 10px;border-radius: 12px">
                        ...
                        <div class="alert alert-danger">
                            ...
                            <strong>Peringatan !</strong> <?php echo e(Session('msg')); ?>
                ...
                <a href="<?php echo e(url('/registrasi')); ?>" style="color: white"> belum punya akun ?</a>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\website_carent\resources\views/login.blade.php ENDPATH**/ ?>