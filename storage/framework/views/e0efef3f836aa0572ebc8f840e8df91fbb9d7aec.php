<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('assets/plugins/datepicker/dist/css/bootstrap-datepicker.min.css')); ?>">
    <script src="<?php echo e(url('/sweetalert.js')); ?>"></script>
    <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    <script src="<?php echo e(url('assets/plugins/datepicker/dist/js/bootstrap-datepicker.min.js')); ?>"></script>
...
<body>
    <div class="d-flex">
        ...
        <div id="page-content-wrapper" style="background-color: #f4f4f5">
            <?php $__currentLoopData = $daftarmenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="jumbotron jumbotron-fluid sticky-top" style="color: #ffffff;background-image: url('<?php echo e(url('/asset/assets/5.jpg')); ?>')">
                <div class="row d-flex justify-content-center">
                    <div class="col-2">
                        <center><img src="<?php echo e($d->foto_profile); ?>" class="card-img-top"></center>
                    </div>
                    <div>
                        <h2><?php echo e($d->nama_garasi); ?></h2>
                        <p><strong>Alamat: </strong> <?php echo e($d->alamat); ?></p>
                        
                        <p><strong>Tipe Kendaraan: </strong>
                            <?php $__currentLoopData = $daftarmobil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="tags"><?php echo e($q->jenis_mobil); ?></span> 
            ...
            <div class="container-fluid">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $daftarmobil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                        <tr class="data-row">
                            <td class="jenis_mobil">
                                <?php echo e($a->jenis_mobil); ?>

                            </td>
                            <td class="golongan">
                                <?php echo e($a->golongan); ?>

                            </td>
                            <td class="id_mobil">
                                <?php echo e($a->id_mobil); ?>
                            ...
                            <td>
                                <button type="button" class="btn btn-info " data-toggle="modal" data-target="#pic-modal<?php echo e($a->id_mobil); ?>">Show</button>
                            </td>
                            <td>
                                <?php echo e($a->status); ?>
    ...
    <!-- Modal Gambar -->
    <?php $__currentLoopData = $daftarmobil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div id="pic-modal<?php echo e($siap->id_mobil); ?>" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <?php $__currentLoopData = $daftarmenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $garasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="modal-header">
                        <h6><strong>Mobil dari <?php echo e($garasi->nama_garasi); ?></strong></h6>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <div class="modal-body">
                        
                        <img src="<?php echo e($siap->foto); ?>" class="img-thumbnail">
                    </div>
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <form id="edit-form" action="<?php echo e(url('/pesan/confirm/'.$a->email_owner)); ?>" method="POST">
...
</body><?php /**PATH C:\xampp\htdocs\website_carent\resources\views//pesan.blade.php ENDPATH**/ ?>